...
const Testimonial = () => {
    return (
        <div className="">
            <Swiper pagination={true} modules={[Pagination]} className="mySwiper flex justify-center mx-auto lg:my-20 md:my-10 my-10">
                <SwiperSlide><div className="pb-10 lg:w-1/2 md:w-2/3 w-full lg:px-0 md:px-0 px-10 mx-auto">
                    <BiSolidQuoteLeft className="text-9xl text-gray-300 text-center mx-auto mb-5"></BiSolidQuoteLeft>
                    <p className="w-full lg:text-lg md:text-base text-sm text-center italic">PrismTask has revolutionized my approach to project management as a web developer. Its sleek interface and seamless integration with development tools make it a standout choice. Tracking tasks, managing deadlines, and collaborating with the team has never been easier. PrismTask has become an indispensable asset in my toolkit, enhancing both efficiency and project success.</p>
